...
*                                                                             *
******************************************************************************/
#ifndef _UNKNOWNSERVICE_H_
#define  _UNKNOWNSERVICE_H_

#include "L3Service.h"
class UnknownHostService: public L3Service
{
	public:
		UnknownHostService();
		UnknownHostService(bnc::l3service::service_type type);
		~UnknownHostService();
	private:
