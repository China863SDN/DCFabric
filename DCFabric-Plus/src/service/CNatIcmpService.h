...
#ifndef  _CNATICMPSERVICE_H_
#define  _CNATICMPSERVICE_H_

#include "NatService.h"
class CNatIcmpService: public NatService
{
	public:
		CNatIcmpService(){};
		CNatIcmpService(bnc::l3service::service_type type):NatService(type){};
		~CNatIcmpService(){};
	protected:
