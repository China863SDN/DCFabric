...
#ifndef  _FLOATINGSERVICE_H_
#define   _FLOATINGSERVICE_H_

#include "L3Service.h"
class  FloatingService: public L3Service
{
	public:
		FloatingService();
		FloatingService(bnc::l3service::service_type type);
		~FloatingService();
	public:
