...
/******************************************************************************
*                                                                             *
*   File Name   : CPortforwardService.h                                       *
*   Author      : bnc bojiang                                                 *
...
*                                                                             *
******************************************************************************/
#ifndef __PORTFORWARDSERVICE_H
#define __PORTFORWARDSERVICE_H

#include "L3Service.h"

class CPortforwardService : public L3Service
{
public:
	CPortforwardService();
	virtual ~CPortforwardService();
